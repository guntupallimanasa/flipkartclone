...
import { getProductsDetailsByID } from '../../actions';
import {
  IoIosArrowForward,
  IoIosStar,
  IoMdCart
...
export const ProductDetailsPage = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(getProductsDetailsByID(payload))
  }, [])
        ...
        <div className="flexRow">
          <div className="verticalImageStack">
            {
              product.productDetails.productPictures.map((thumb, index) =>
                <div className="thumbnail">
                  <img src={generalPublicUrl(thumb.img)} alt={thumb.img} />
                </div>
              )
            }
          ...
          <div className="productDescContainer">
            <div className="productDescImgContainer">
              <img src={generalPublicUrl(product.productDetails.productPictures[0].img)} alt={`${product.productDetails.productPictures[0].img}`} />
            </div>
